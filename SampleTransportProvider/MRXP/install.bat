...
copy .\release\mrxp32.pdb %windir%\sysWow64
rundll32 %windir%\syswow64\mrxp32.dll MergeWithMAPISVC
goto END

:64BITOUTLOOK
echo 64-bit Windows and 64-bit Office installed
copy x64\Debug\mrxp32.dll %windir%\system32
copy x64\Debug\mrxp32.pdb %windir%\system32
...
copy .\release\mrxp32.pdb %windir%\system32
rundll32 %windir%\system32\mrxp32.dll MergeWithMAPISVC
